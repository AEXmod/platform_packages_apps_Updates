...
import com.aospextended.ota.service.DownloadCompleteIntentService;
import com.aospextended.ota.service.DownloadService;

public class DownloadReceiver extends BroadcastReceiver {
    public static final String ACTION_START_DOWNLOAD = "com.aospextended.ota.action.START_DOWNLOAD";
    public static final String EXTRA_UPDATE_INFO = "update_info";
    public static final String ACTION_DOWNLOAD_STARTED = "com.aospextended.ota.action.DOWNLOAD_STARTED";
