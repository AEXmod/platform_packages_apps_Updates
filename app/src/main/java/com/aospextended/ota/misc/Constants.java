...
public class Constants {
    ...
    public static final String DOWNLOAD_CHANNEL_ID = "com.aospextended.ota.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "com.aospextended.ota.DOWNLOADING_CHANNEL";
    // Preferences
    ...
    public static final String OTA_URL = "https://cnodax-studio.ru/aexmod/%s";
    // Expressions
